...
const timeInform = false; //Информаирование о наступлении дня/ночи
...
var boss2 = [
    ['-00:30-','-07:00-','-11:00-','-15:00-','-18:00-','-23:00-'],
    ['Нуб/Кар','-Нубэр-','-Кзарка','Кза/Нуб','Кза/Кут','Кар/Нуб'],
    ['-Офин--','-Кутум-','-Кзарка','Кза/Кут','Кза/Нуб','Кар/Кут'],
    ['-Нубэр-','Каранда','-Нубэр-','Кза/Кут','Кза/Нуб','Кар/Кза'],
    ['','-Кзарка','-Кутум-','Кза/Нуб','Кар/Кут','Кут/Нуб'],
    ['','','Каранда','Кзарка/Кутум','Каранда/Нубэр','Кза/Кут'],
    ['-Нубэр-','','Кар/Ну','Кви/Мур','-Офин--','Кар/Кут'],
    ['-Нубэр-','Каранда','Кар/Кут','-Велл--','-Офин--','Кза/Кут']
];
